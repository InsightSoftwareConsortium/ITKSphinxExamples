# -*- coding: utf-8 -*-
#
# ITK Examples documentation build configuration file, created by
...
project = u'ITK Examples'
copyright = u'2011, Insight Software Consortium'
...
logo = os.path.join('static', 'itk_eg_logo.png')
...
itk_blue = '#2c56a4'
bright_blue = '#dee9ff'
less_bright_blue = '#ccdeff'
dull_blue = '#264a8c'
dull_blue = '#25498a'
meh_dull_blue = '#244787'
more_dull_blue = '#224380'
dark_borders_bg = '#0a001f'
...
htmlhelp_basename = 'ITKExamplesdoc'
...
latex_documents = [
  ('index', 'ITKExamples.tex', u'ITK Examples Documentation',
...
man_pages = [
    ('index', 'itkexamples', u'ITK Examples',
