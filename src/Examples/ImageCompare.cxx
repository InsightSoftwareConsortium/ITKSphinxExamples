...
int main(int argc, char **argv)
{
  if(argc < 3)
    {
    cerr << "Usage:" << endl;
    cerr << "testImage, baselineImage1, [baselineImage2, ";
    cerr << "baselineImage3, ...]" << endl;
    cerr << "Note that if you supply more than one baselineImage, ";
    cerr << "this test will pass if any " << endl;
                         ...
                         int reportErrors, bool differences)
{
  ...
  try
    ...
    std::cerr << baselineImageFilename << " : "  << e.GetDescription();
    return 1000;
    }
  ...
  if (baselineSize != testSize)
    {
    std::cerr << "The size of the Baseline image and Test image do not ";
